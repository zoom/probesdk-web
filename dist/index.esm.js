...
function _buildDetector(nav) {
  var parser = new UAParser(nav.userAgent || "");
...
export { BANDWIDTH_QUALITY_LEVEL, BASIC_INFO_ATTR_INDEX, ERR_CODE, NETWORK_QUALITY_LEVEL, NET_PROBING_DATA_TYPE, PROTOCOL_TYPE, Prober, RENDERER_TYPE, Reporter, SUPPORTED_FEATURE_INDEX };
